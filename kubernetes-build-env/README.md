...
# for kubernetes 1.16.x
docker run --name=k8s-build -it -v <kubernetes source path>:/root/workplace -v <gopath>:/go ccr.ccs.tencentyun.com/fuzhibo/k8s-build-env:1.13.4 bash
